...
export default function Nav({
	...
	return (
		<nav className="fixed md:relative md:bg-almostWhite dark:bg-background-70 m-4 md:border-2  dark:border-solid lg:min-w-fit lg:w-72 md:w-60 transition-all ease-in-out duration-200 h-fit md:h-[calc(100vh-4rem)] md:shadow-spread dark:shadow-sm rounded-2xl backdrop-blur border-border/40 items-center">
