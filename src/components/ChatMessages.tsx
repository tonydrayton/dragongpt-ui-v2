        ...
        >
          ...
          >
            ...
            {message.isUser ? (
              ...
              <span
				className={`max-w-lg overflow-hidden text-wrap whitespace-pre-wrap break-words tracking-tight ${isStreaming && message.text.length === 0 && "after:content-[''] after:w-0.5 after:h-5 after:bg-black after:animate-blink after:ml-1 after:inline-block"}`}
                style={{ wordBreak: "break-word" }}
                id="bot-response"
                // className="leading-8"
